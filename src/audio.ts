...
const guardSeeThiefSet:Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/what in the shadows.mp3'), 'What\'s in\nthe shadows?'],
    [require('url:./audio/guards/shadow move.mp3'), 'Did the\nshadows move?'],
    [require('url:./audio/guards/see something.mp3'), 'Did I see\nsomething?'],
...
const guardFinishLookingSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/jumpin shadows.mp3'), 'I\'m jumpin\' at\nshadows...'],
    ...
    [require('url:./audio/guards/case of the jitters.mp3'), 'Case of the\njitters...'],
    [require('url:./audio/guards/must be seeing.mp3'), 'Must be\nseeing...'],
    ...
    [require('url:./audio/guards/seeing things.mp3'), 'Must be\nseeing\nthings...'],
    [require('url:./audio/guards/seeing things.mp3'), 'I must be\nseeing things.'],
];
...
const guardFinishListeningSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/coffee too strong.mp3'), 'Coffee must be\ntoo strong!'],
    [require('url:./audio/guards/hmm nothing.mp3'), 'Hmm nothing...'],
    [require('url:./audio/guards/cant hear now.mp3'), 'Can\'t hear\nit now.'],
    [require('url:./audio/guards/nothing.mp3'), 'Nothing...'],
    [require('url:./audio/guards/hopefully nothing.mp3'), 'Hopefully\nnothing.'],
...
const guardInvestigateSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/better be rats.mp3'), 'Better be\nrats!'],
    [require('url:./audio/guards/again.mp3'), 'Again!?'],
    [require('url:./audio/guards/who that.mp3'), 'Who is that?'],
    [require('url:./audio/guards/come out come out.mp3'), 'Come out,\nCome out!'],
];
