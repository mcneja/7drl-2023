...
const guardSeeThiefSet:Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/who there.mp3'), 'Who\'s out there?'],
    [require('url:./audio/guards/what moved.mp3'), 'What moved?'],
    [require('url:./audio/guards/what in the shadows.mp3'), 'What\' in the shadows?'],
    [require('url:./audio/guards/shadow move.mp3'), 'Did the shadows move?'],
    [require('url:./audio/guards/see something.mp3'), 'Did I see something?'],
    [require('url:./audio/guards/hello.mp3'), 'Hello?'],
    [require('url:./audio/guards/ugh.mp3'), 'Ugh...'],
];
...
const guardFinishLookingSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/jumpin shadows.mp3'), 'I\'m jumpin\' at shadows...'],
    [require('url:./audio/guards/ahh.mp3'), 'Ahh...'],
    [require('url:./audio/guards/ahh.mp3'), 'Ahh...'],
    [require('url:./audio/guards/Hmm.mp3'), 'Hmm...'],
    [require('url:./audio/guards/aww.mp3'), 'Aww...'],
    [require('url:./audio/guards/rest me bones.mp3'), 'Rest me bones...'],
    [require('url:./audio/guards/oh well.mp3'), 'Oh well...'],
    [require('url:./audio/guards/case of the jitters.mp3'), 'Case of the jitters...'],
    [require('url:./audio/guards/must be seeing.mp3'), 'Must be seeing...'],
    [require('url:./audio/guards/what in my coffee.mp3'), 'What\'s in my coffee today?'],
    [require('url:./audio/guards/coffee too strong.mp3'), 'Coffee must be too strong!'],
    [require('url:./audio/guards/hmm nothing.mp3'), 'Hmm nothing...'],
    [require('url:./audio/guards/well I though I saw.mp3'), 'Well I though I saw something.'],
    [require('url:./audio/guards/nothing.mp3'), 'Nothing...'],
    [require('url:./audio/guards/hopefully nothing.mp3'), 'Hopefully nothing.'],
    [require('url:./audio/guards/seeing things.mp3'), 'Must be seeing things...'],
    [require('url:./audio/guards/seeing things.mp3'), 'I must be seeing things.'],
];
...
const guardFinishListeningSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/coffee too strong.mp3'), 'Coffee must be too strong!'],
    [require('url:./audio/guards/hmm nothing.mp3'), 'Hmm nothing...'],
    [require('url:./audio/guards/cant hear now.mp3'), 'Can\'t hear it now.'],
    [require('url:./audio/guards/nothing.mp3'), 'Nothing...'],
    [require('url:./audio/guards/hopefully nothing.mp3'), 'Hopefully nothing.'],
    [require('url:./audio/guards/hearing things.mp3'), 'I must be hearing things.'],
];
...
const guardInvestigateSet: Array<SubtitledSoundDesc> = [
    ...
    [require('url:./audio/guards/hey-3.mp3'), 'Hey!'],
    [require('url:./audio/guards/What.mp3'), 'What?'],
    [require('url:./audio/guards/noise again.mp3'), 'That noise again?'],
    [require('url:./audio/guards/someone there.mp3'), 'Someone there?'],
    [require('url:./audio/guards/who could that be.mp3'), 'Who could that be?'],
    [require('url:./audio/guards/there it is again.mp3'), 'There it is again.'],
    [require('url:./audio/guards/better check it out.mp3'), 'Better check it out.'],
    [require('url:./audio/guards/what keeps making those noises.mp3'), 'What keeps making those noises?'],
    [require('url:./audio/guards/better be rats.mp3'), 'Better be rats!'],
...
const guardFinishInvestigatingSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/Hmm.mp3'), 'Hmm...'],
    [require('url:./audio/guards/jumpin shadows.mp3'), 'Jumpin\' at shadows!'],
    [require('url:./audio/guards/jumpy.mp3'), 'Jumpy!'],
    [require('url:./audio/guards/oh well.mp3'), 'Oh, well.'],
    [require('url:./audio/guards/guess nothing.mp3'), 'Guess it was nothing.'],
    ...
    [require('url:./audio/guards/sure I heard something.mp3'), 'I\'m sure I heard something.'],
    ...
    [require('url:./audio/guards/hmm nothing.mp3'), 'Hmm, nothing.'],
    [require('url:./audio/guards/i dont know why i work here.mp3'), 'I dont know why I work here.'],
    [require('url:./audio/guards/waste of my time.mp3'), 'Waste of my time.'],
    [require('url:./audio/guards/why do I even try.mp3'), 'Why do I even try.'],
    [require('url:./audio/guards/at least Im not on cleaning duty.mp3'), 'At least I\'m not on cleaning duty.'],
    [require('url:./audio/guards/at least my shift ends soon.mp3'), 'At least my shift ends soon.'],
...
const guardHearGuardSet: Array<SubtitledSoundDesc> = [ //Repond to guards that enter the chase set
    ...
    [require('url:./audio/guards/i dont know how to whistle.mp3'), 'I dont know how to whistle.'],
];

const guardChaseSet: Array<SubtitledSoundDesc> = [ //Yells a warning that will be heard by other guards
    [require('url:./audio/guards/whistle.mp3'), '*Whistles*'],
    [require('url:./audio/guards/whistle-2.mp3'), '*Whistles*'],
    [require('url:./audio/guards/whistle-3.mp3'), '*Whistles*'],
...
const guardEndChaseSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/lost em.mp3'), 'Lost \'em!'],
    [require('url:./audio/guards/must have run.mp3'), 'Must have run off...'],
    [require('url:./audio/guards/oh well.mp3'), 'Oh, well...'],
    ...
    [require('url:./audio/guards/huff puff give up.mp3'), '*Huff* *Huff* *Huff* I give up!'],
    ...
    [require('url:./audio/guards/wont get away next time.mp3'), 'You won\'t get away next time!'],
    [require('url:./audio/guards/for his holiness.mp3'), 'His Holiness is a lord of mercy!'],
    [require('url:./audio/guards/lousy day at work.mp3'), 'What a lousy day at work!'],
    ...
    [require('url:./audio/guards/guard rant.mp3'), '*Long and excessive rant that should have been cut from the game*'],
];
...
const guardStirringSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/ahh.mp3'), '*Stirring* Ahh...'],
]
...
const sleeperAwakesWarningSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/who there.mp3'), 'Who\'s out there?'],
];

const sleeperBackToSleepSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/ahh-2.mp3'), 'Zzzz...'],
];

const yellingForGuardsSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/guards/thief.mp3'), 'Thief!!!'],
    [require('url:./audio/guards/thief-2.mp3'), 'Thief!!!'],
    [require('url:./audio/guards/thief-3.mp3'), 'Thief!!!'],
];

const trackerYellingForGuardsSet: Array<SubtitledSoundDesc> = [
    [require('url:./audio/dog/dog0.mp3'), '*Grr*'],
    [require('url:./audio/dog/dog1.mp3'), '*Grr*'],
    [require('url:./audio/dog/dog2.mp3'), '*Grr*'],
    [require('url:./audio/dog/dog3.mp3'), '*Grr*'],
    [require('url:./audio/dog/dog4.mp3'), '*Grr*'],
    [require('url:./audio/dog/dog5.mp3'), '*Grr*'],
];
...
export function setupSounds(sounds:Howls, subtitledSounds:SubtitledHowls, howlPool: ActiveHowlPool) {
    ...
    subtitledSounds.sleeperAwakesWarning = new SubtitledHowlGroup(sleeperAwakesWarningSet, howlPool);
    subtitledSounds.sleeperBackToSleep = new SubtitledHowlGroup(sleeperBackToSleepSet, howlPool);
    subtitledSounds.yellingForGuards = new SubtitledHowlGroup(yellingForGuardsSet, howlPool);
    subtitledSounds.trackerYellingForGuards = new SubtitledHowlGroup(trackerYellingForGuardsSet, howlPool);
}
