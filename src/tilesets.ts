...
const tileSet31Color:TileSet = {
    ...
    terrainTiles: [ 
        ...
        {textureIndex: r([13, 12]),  color:colorPreset.white, unlitColor:0xffa07070}, // TerrainType.PortcullisNS,
    ...
    itemTiles: [
        ...
        {textureIndex: r([13, 12]), color:colorPreset.white,      unlitColor:0xffa07070}, // ItemType.PortcullisNS,
