...
const tileSet31Color:TileSet = {
    ...
    terrainTiles: [ 
        ...
        {textureIndex: r([7,   4]),  color:colorGroundLit,    unlitColor:colorGroundUnlit}, // TerrainType.GroundWood,
        {textureIndex: r([7,   5]),  color:colorWoodFloorLit, unlitColor:colorGroundUnlit}, // TerrainType.GroundWoodCreaky,
        {textureIndex: r([5,   4]),  color:colorWoodFloorLit, unlitColor:colorGroundUnlit}, // TerrainType.GroundVault,
