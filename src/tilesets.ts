...
const tileSet31Color:TileSet = {
    ...
    terrainTiles: [ 
        {textureIndex: r([11,  4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GroundNormal,
        {textureIndex: r([8,   4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GroundGrass,
        {textureIndex: r([10,  4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GroundWater,
        {textureIndex: r([0,   4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GroundMarble,
        {textureIndex: r([7,   4]),  color:colorPreset.white, unlitColor:colorPreset.darkerGray}, // TerrainType.GroundWood,
        {textureIndex: r([11,  5]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GroundWoodCreaky,
        ...
        {textureIndex: r([14, 12]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.PortcullisNS,
        {textureIndex: r([13, 12]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.PortcullisEW,
        ...
        {textureIndex: r([2+6, 4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GardenDoorNS,
        {textureIndex: r([2+6, 4]),  color:colorPreset.white, unlitColor:colorPreset.darkGray}, // TerrainType.GardenDoorEW,
    ], 
    itemTiles: [
