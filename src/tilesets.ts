...
const tileSet31Color:TileSet = {
    ...
    touchButtons: {
        ...
        'zoomOut':          {textureIndex: r([6,  1]), color:0xa0ffffff, unlitColor:0x80ffffff},
        'zoomIn':           {textureIndex: r([7,  1]), color:0xa0ffffff, unlitColor:0x80ffffff},
    ...
    terrainTiles: [ 
        ...
        {textureIndex: r([11,  3]),  color:colorPreset.yellowTint,  unlitColor:colorPreset.midGray}, // TerrainType.PortcullisNS,
    ...
    itemTiles: [
        ...
        {textureIndex: r([11,  3]),  color:colorPreset.white,      unlitColor:colorPreset.midGray}, // ItemType.PortcullisNS,
