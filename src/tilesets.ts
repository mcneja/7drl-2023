...
const tileSet31Color:TileSet = {
    ...
    fortressTerrainTiles: [ 
        ...
        {textureIndex: r([1,   6]),  color:colorWallLit,      unlitColor:colorWallUnlit},   // TerrainType.Wall0100,
        ...
        {textureIndex: r([3,   6]),  color:colorWallLit,      unlitColor:colorWallUnlit},   // TerrainType.Wall1000,
